...
def plot_folder(folder_path, output_dir, calculator):
	...
	if rx_vol is not None:
		...
		ax.plot(x_rx, rx_vol, color="#ff7f0e", linewidth=1.0, label="RX")
		...
		ax.set_xlabel("Sample (us)")
		ax.set_ylabel("Amplitude")
		ax.grid(True, alpha=0.2)
		ax.legend(loc="upper right")
	else:
		ax.set_title("RX Signal (missing)")
		ax.axis("off")
...
def main():
	...
	data_root = os.path.join(script_dir, "260206", "Sensor_1")
	output_dir = os.path.join(script_dir, "260206_plots")
